...
--
ALTER TABLE `lancamento`
  MODIFY `codCadastro` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `pessoa`
  MODIFY `codPessoa` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
